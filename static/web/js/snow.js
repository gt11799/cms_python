 ...
 // Cross-browser-compliant  
    ...
    // Start snow  
    function startSnow () {  
        var snowHeight = $(".wrap_overlay").offset().top-30;
        // Create canvas  
        var canvas = document.createElement ('canvas'), cxt;  
        canvas.height = snowHeight;  
        canvas.width = window.innerWidth;  
        canvas.setAttribute ('style', 'position: absolute;width:100%; left: 0;top: 0;pointer-events: none; z-index:1010');  
